                                            ...
                                            <?php foreach ($allDokter as $b) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="mb-3">
                                                                                <!-- <label>ID DOKTER</label> -->
                                                                                <input type="hidden" class="form-control" name="id_dokter" value="<?= $b["ID_DOKTER"] ?>">
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label>NAMA DOKTER</label>
                                                                                <input type="text" class="form-control" name="nama_dokter" value="<?= $b["NAMA_DOKTER"] ?>">
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="spesialis">SPESIALIS</label>
                                                                                <select class="form-control select2" name="spesialis" style="width: 100%;">
                                                                                    <?php foreach ($spesialis as $sp) : ?>
                                                                                        <option value="<?= $sp ?>" <?= ($b['SPESIALIS'] == $sp) ? 'selected' : ''; ?>>
                                                                                            <?= $sp ?>
                                                                                        </option>
                                                                                    <?php endforeach; ?>
                                                                                </select>
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <select class="form-control select2" name="jenisk_dokter" style="width: 100%;">
                                                                                    <?php foreach ($jeniskelamin as $jk) : ?>
                                                                                        <option value="<?= $jk ?>" <?= ($b["JENIS_KELAMIN_DOKTER"] == $jk) ? 'selected' : ''; ?>>
                                                                                            <?= $jk ?>
                                                                                        </option>
                                                                                    <?php endforeach; ?>
                                                                                </select>
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <label>ALAMAT DOKTER</label>
                                                                                <input type="text" class="form-control" name="alamat" value="<?= $b["ALAMAT_DOKTER"] ?>">
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label>NO TELP DOKTER</label>
                                                                                <input type="number" class="form-control" name="nohp_dokter" value="<?= $b["TELP_DOKTER"] ?>">
                                                                            </div>
                                                                            <div class="modal-footer justify-content-between">
                                                                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                            ...
                                                            <div class="modal fade" id="modal-delete<?= $b["ID_DOKTER"] ?>">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer justify-content-between">
                                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                                            <button type="submit" name="t_delete" class="btn btn-primary">Hapus</button>
                                                                        </div>
                                                                    </div>
                                                                    <!-- /.modal-content -->
                                                                </div>
                                                        ...
                                                        <button type="submit" data-toggle="modal" data-target="#modal-edited<?= $b["ID_DOKTER"] ?>" name="t_edit" class="btn btn-success btn-sm">Edit</button>
                                                        <button type="submit" data-toggle="modal" data-target="#modal-delete<?= $b["ID_DOKTER"] ?>" name="t_delete" id="t_delete" class="btn btn-danger btn-sm">Hapus</button>
